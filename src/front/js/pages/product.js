...
export const Product = () => {
	...
	return ( 
        ...
        <h1 className="fw-normal p-0 shadow-none p-5 mb-5 bg-light rounded-4 border border-dark" style={{textAlign: "center" , boxShadow: "0.2"}}>
<form class="d-flex" role="search">
        <input class="form-control me-2" type="search" placeholder="Buscar Productos" aria-label="Search" ></input>  <img src="https://img.icons8.com/material-outlined/2x/search.png"/> </form>
</h1>
...
<div className="d-grid gap-4 d-md-flex justify-content-md-center pt-5">
  <button className="btn btn-success mt-5 " type="button">Crear Producto</button>
