...
export const Shop = () => {
	...
	return ( 
    <>
    <h1 className="mt-5 pt-5" style={{textAlign: "center"}}> CATEGORIAS</h1>
    <div className="container  justify-content-center mt-5">
    <div className="row row-cols-1 row-cols-md-3 mb-3 text-center">
    <div className="col">
      <div className="card mb-4 rounded-3">
        <div className="card-header py-3">
        <svg className="bd-placeholder-img card-img-top" width="100%" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595C"></rect><text x="20%" y="50%" fill="#ECEEEF" dy=".3em">Imagen Producto</text></svg>

        </div>
        <div className="card-body">
          <h1 className="card-title pricing-card-title">Categoria 1</h1>
          
          <button type="button" className="w-100 btn btn-lg btn-outline-dark">Revisar productos</button>
        </div>
      </div>
    </div>
    <div className="col">
